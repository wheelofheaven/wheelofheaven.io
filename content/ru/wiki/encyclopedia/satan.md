...
- Prosecutor
- שָׂטָן
description: 'Сатана (śāṭān, иврит: שָׂטָן), не путать с Люцифером, является Элоха
  (אֱלוֹהַּ) и представителем фракции внутри Элохима (אֱלֹהִים), которая выступает
  против существования процветающей цивилизации-потомка на Земле, которая рассматривается
  как угроза их отдаленному благополучию. Таким образом, сатана — это не имя собственное,
  а показательная форма роли, которую играет сатана, а именно — препятствующего, обвинителя
  или даже обвинителя.'
lead: 'Сатана (śāṭān, иврит: שָׂטָן), не путать с Люцифером, является Элоха (אֱלוֹהַּ)
  и представителем фракции внутри Элохима (אֱלֹהִים), которая выступает против существования
  процветающей цивилизации-потомка на Земле, которая рассматривается как угроза их
  отдаленному благополучию. Таким образом, сатана — это не имя собственное, а показательная
  форма роли, которую играет сатана, а именно — препятствующего, обвинителя или даже
  обвинителя.'
