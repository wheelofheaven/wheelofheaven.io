...
description: Прецессия, устойчивое изменение ориентации оси вращения Земли. Прецессия
  — это третье ключевое движение Земли после вращения вокруг своей оси (дневной цикл)
  и обращения вокруг Солнца (год). Полный прецессионный цикл занимает 25 920 лет.
lead: Устойчивое изменение ориентации оси вращения Земли. Прецессия — это третье ключевое
  движение Земли после вращения вокруг своей оси (дневной цикл) и обращения вокруг
  Солнца (год). Полный прецессионный цикл занимает 25 920 лет.
